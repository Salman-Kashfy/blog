...
<div class="col-xs-12 col-sm-6 index_post <?php if($clearfix){echo 'clear';} ?>">
			...
			<div class="index_content">
                ...
                <?php if(sunset_get_embedded_media( array('audio','iframe') )): ?>

                    <span class="box audio">
                ...
                <?php else: ?>
                <div class='box no_thumbnail'><div class='table'><div class='table-cell'><i class="fa fa-headphones" aria-hidden="true"></i></div></div></div>
